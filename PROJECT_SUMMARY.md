...
**Last updated:** 2026-08-24 (Live redemption notifications - non-owners can now redeem a shared coupon at all via a member-scoped endpoint, redemptions are atomic, and full/partial redeems notify everyone who can see the coupon. Also fixed a latent notification-ordering bug that was silently dropping coupon codes from shares.)
